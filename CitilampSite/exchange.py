...
def convertCurrency(currency_from , currency_to, quantity):
    """
    ...
    :param quantity: type Int the quantity of the currency_from  you want to convert
    :return: type Int the value of the quantity when converted to the currency specified by the param currency_to
    """
